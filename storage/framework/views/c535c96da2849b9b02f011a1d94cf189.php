...
<?php $__env->startSection('content'); ?>
    <main class="col-10 col-sm-7 offset-1">
        ...
        <div class="row col-12 justify-content-around block-ticket">
            ...
            <section class="ticket fw-bold col-4 col-md-3">
                <a href="/asigntome"><p class="text-center  col-12">Tickets à traiter</p>
...
<?php echo $__env->make('layout/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\AMT Projects\Ticket Project\Version Controller Ticket\Ticket\resources\views/dashboard.blade.php ENDPATH**/ ?>