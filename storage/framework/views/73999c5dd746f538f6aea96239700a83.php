...
<?php $__env->startSection('content'); ?>
    <main class="col-8" style="margin-left: 1.3%">
            ...
            <h2 class="text-center text-uppercase fw-bold fs-1 title col-12">Tickets que je dois traiter</h2>
            ...
            <table class="border table">
                ...
                <tbody>
                   ...
                   <?php endif; ?>
                    <?php $__currentLoopData = $asign_to_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\AMT Projects\Ticket Project\Version Controller Ticket\Ticket\resources\views/ticket/asignToUser.blade.php ENDPATH**/ ?>